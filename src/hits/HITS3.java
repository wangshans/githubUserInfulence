...
//    			nodeSet.add(n2);
    ...
    public ArrayList<Integer> getIncomingNeighbors(Integer node){
		...
		try{
			...
			BufferedReader read = BF.readFile("data\\NodeIncomings.csv");
	...
	public ArrayList<Integer> getOutgoingNeighbors(Integer node){
		try{
			...
			BufferedReader read = BF.readFile("data\\NodeOutgoings.csv");
    		String line = "";
    		while((line=read.readLine())!=null){
    			String[] words = line.split(",");
    			int nodeid = Integer.valueOf(words[0]);
   ...
   public void clear(){
	...
	File netFile = new File("E:\\mysql-2015-09-25\\screen\\tables\\followers0.csv");
